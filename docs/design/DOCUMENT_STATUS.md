...
| [FoodNeed M_B Admission計画](RDL_GameAI_FoodNeed_M_B_Admission実装計画.md) | PR 1-2 operational | opt-in acquisition、immutable relation、offline shadow F/F'/E。bridge/global sidecar接続は未実装 |
