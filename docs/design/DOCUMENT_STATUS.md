...
| [OBS-9 Observation v1 Completion draft](../experiment-contracts/OBS_9_observation_v1_completion_contract.md) | design-only / v1 incomplete | 全感覚生活＋Probeの統合受入10条件。全件PASSでv1 COMPLETEとして固定。OBS-9未実施 |
