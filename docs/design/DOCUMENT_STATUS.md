...
| [Observation System Integration Plan](RDL_GameAI_Observation_System_Integration_Plan.md) | active implementation plan v0.2 | OBS-0〜5完了。個体別profile、隔離store、近景、有限遠景、最小聴覚、動的受信窓、p5個体別表示を導入。次はOBS-6統合回帰、感覚融合・行動接続・嗅覚は保留 |
