...
| [OBS-8B Continuous World Probe draft](../experiment-contracts/OBS_8B_continuous_world_probe_contract.md) | design-only / not implemented | 継続時計、個体別実行権限、生活優先、通常視覚枠の所有、遅延応答と配送ackの分離。試験未実施 |
