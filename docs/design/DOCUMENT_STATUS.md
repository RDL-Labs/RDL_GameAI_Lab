...
| [Observation System Integration Plan](RDL_GameAI_Observation_System_Integration_Plan.md) | active implementation plan v0.2 | OBS-0〜3完了。個体別SensorProfile、共通frame、隔離store、近景設定化、有限遠景を導入。次はOBS-4最小聴覚、感覚融合・行動接続・嗅覚は保留 |
