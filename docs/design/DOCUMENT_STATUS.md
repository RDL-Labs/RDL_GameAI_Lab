...
| [Sleep / Fast-Deep Experience Loop実装計画](RDL_GameAI_Sleep_FastDeep循環実装計画.md) | active implementation plan v0.1 | S1 finite window完了。次はS2 Profile、以後Deep candidate、翌朝Fast retrieval、Phase 8 Hunting |
