...
| [OBS Integrated Life Regression contract](../experiment-contracts/OBS_integrated_life_regression_contract.md) | OBS-6 operational reference | RW2生活とA/B別local/distant/auditionを同一World/Runtimeで併走。単独fixtureと共通sensor kernelを使用し、実feature/detection、独立時刻、拒否0、有限生活互換を固定。action列同一性は未主張 |
