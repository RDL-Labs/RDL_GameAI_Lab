...
| [Luanti Integration Roadmap](RDL_GameAI_Luanti_Integration_World_Backend_Transition_Roadmap.md) | active infrastructure roadmap | L0-L7完了。Luantiを主World統合面、Godotをregression fixtureとして保持。L8 multi-agent分離が次 |
