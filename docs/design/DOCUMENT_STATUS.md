...
| [Minimal Safety flee contract](../experiment-contracts/SAFETY_minimal_flee_contract.md) | opt-in bounded danger-exit loop operational | static danger zone、bounded exposure、safe targetへのflee、圏外でidle。Threat・負傷は未実装 |
