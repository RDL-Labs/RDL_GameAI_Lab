...
| [Base–Food assisted contract](../experiment-contracts/BASE_FOOD_assisted_loop_contract.md) | Phase 1-5 operational | cue-result経験、2成功閾値、cueなし自律完遂まで。interrupt系はdeferred |
