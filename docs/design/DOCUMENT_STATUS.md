...
| [Sleep / Fast-Deep Experience Loop実装計画](RDL_GameAI_Sleep_FastDeep循環実装計画.md) | active implementation plan v0.1 | S1-S4とF1 Fast Retrieval完了。次はF2 Fast-Deep one-cycle Evidence、その後Core同期 |
