...
| [感覚観測の解釈・利用への接続計画](RDL_GameAI_Sensory_Interpretation_Use_Plan.md) | design-only / OBS-7A next proposal | OBS-6Eを有限観測基盤として固定。比較適格性・姿勢対応不足・出典・予算・受入試験を定義。候補生成・行動接続は未実装 |
