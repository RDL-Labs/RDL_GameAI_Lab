...
| [Observation System Integration Plan](RDL_GameAI_Observation_System_Integration_Plan.md) | active implementation plan v0.2 | RW2を基準に個体別SensorProfile、共通frame、隔離store、近景設定化をOBS-0〜2で導入して停止。遠景・聴覚は後続、感覚融合・行動接続・嗅覚は保留 |
