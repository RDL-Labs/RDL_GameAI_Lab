...
| [C4後 Multi-Agent / Territory Beast検証計画](RDL_GameAI_C4後_Multi-Agent_Territory_Beast検証計画.md) | Temporary validation active | R1-R3の3/5/10-agent検証完了。R4 Territory Beastが次 |
