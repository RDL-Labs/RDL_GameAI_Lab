...
- T1-A前の[Multi-Agent / Territory Beast検証](docs/design/RDL_GameAI_C4後_Multi-Agent_Territory_Beast検証計画.md)はR1-R7完了。3/5/10 agentsの分離、Fast cross-agent境界、danger labelを持たないWorld fixture、warning/chase/attack、direct/observer Experience、C1-C4非介入をEvidence化した。次は本線T1-A。
