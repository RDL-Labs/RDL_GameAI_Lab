...
- [Observation System Integration Plan](docs/design/RDL_GameAI_Observation_System_Integration_Plan.md)のOBS-0〜4では、隔離store、個体別近景、有限遠景、最小聴覚を実装した。聴覚は短音window、壁減衰、同一cell混合、個体gain差、overflow欠落を粗い観測として保持し、音源同定・感覚融合・行動接続は未実装のまま保つ。
