...
- Observation resolution: [ρ contract](docs/experiment-contracts/RHO_observation_resolution_contract.md)のFood投影sliceで、同一WorldからLOW / MID / HIGHの有限観測差を生成し、版付き契約でNPC別に選択できる。通常packet・既存action・canonical pathには未接続。
